...
import ru.oepak22.githubmvp.screen.auth.AuthPresenter;
...
public class CommitsActivity extends MvpActivity<CommitsView, CommitsPresenter>
        implements CommitsView, BaseAdapter.OnItemClickListener<CommitResponse> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPresenter().init(getIntent().getStringExtra(REPO_NAME_KEY));
    }
    ...
    @Override
    public void onItemClick(@NonNull CommitResponse item) { getPresenter().onItemClick(item); }
